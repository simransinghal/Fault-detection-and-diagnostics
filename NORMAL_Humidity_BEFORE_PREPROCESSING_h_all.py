...
df=pd.read_csv('/home/seema/plot2.csv', sep=',',header=None)
df.values
...
fig.suptitle('NORMAL Humidity BEFORE PREPROCESSING', fontsize=20)
plt.xlabel('TIME', fontsize=18)
plt.ylabel('ALL Humidity', fontsize=16)
plt.legend(loc='upper right')
fig.savefig('NORMAL_Humidity_BEFORE_PREPROCESSING_temp_all.jpg')
#ax1 = plt.subplot(311)
