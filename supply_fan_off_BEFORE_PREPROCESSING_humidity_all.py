...
df=pd.read_csv('/home/seema/plot4.csv', sep=',',header=None)
df.values
...
fig.suptitle('Supply Fan OFF BEFORE PREPROCESSING', fontsize=20)
plt.xlabel('TIME', fontsize=18)
plt.ylabel('ALL Humidity', fontsize=16)
plt.legend(loc='upper right')
fig.savefig('supply_fan_off_BEFORE_PREPROCESSING_humidity_all.jpg')
#ax1 = plt.subplot(311)
