...
df=pd.read_csv('/home/seema/plot5.csv', sep=',',header=None)
df.values
...
fig.suptitle('OFF BEFORE PREPROCESSING', fontsize=20)
plt.xlabel('TIME', fontsize=18)
plt.ylabel('ALL Humidity', fontsize=16)
plt.legend(loc='upper right')
fig.savefig('off_BEFORE_PREPROCESSING_humidity_all.jpg')
#ax1 = plt.subplot(311)
