...
x = [customdate + datetime.timedelta(minutes=i) for i in range(len(df[1]))]
...
fig.savefig('before_preprocessing_SUPPLY_AND_EXHAUST_FAN_FAULT_BEFORE_PREPROCESSING.jpg')
#ax1 = plt.subplot(311)
