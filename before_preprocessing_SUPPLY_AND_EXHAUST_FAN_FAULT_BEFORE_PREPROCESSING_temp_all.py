...
fig.suptitle('SUPPLY AND EXHAUST FAN FAULT Temp BEFORE PREPROCESSING', fontsize=20)
plt.xlabel('TIME', fontsize=18)
plt.ylabel('ALL Temp', fontsize=16)
plt.legend(loc='upper right')
fig.savefig('before_preprocessing_SUPPLY_AND_EXHAUST_FAN_FAULT_BEFORE_PREPROCESSING_temp_all.jpg')
#ax1 = plt.subplot(311)
